...
class CategoryGroupIterator implements \Iterator
{
  ...
  public function __construct(Oauth2ApiAccessor $accessor, string $apiVersion, string $productsPath, int $pageSize=100, LoggerInterface $logger) {
