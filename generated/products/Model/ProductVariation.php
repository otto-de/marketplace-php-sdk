...
class ProductVariation implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets gtin
     *
     * @param string|null $gtin Global Trade Item Number, formerly known as EAN.
     *
     * @return self
     */
     ...
     *
     * @param int|null $maxOrderQuantity The maximum allowed amount of pieces, the customer can put in one order. Example: with a value of 3, the customer can only buy 3 pieces in one order.
     *
     * @return self
     */
