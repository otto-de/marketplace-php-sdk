 ...
 */
class OnlineStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OnlineStatus';
     ...
     * Sets online
     *
     * @param bool|null $online The product variation is supposed to be online or not
     *
     * @return self
     */
     ...
     * Sets lastModified
     *
     * @param int|null $lastModified the timestamp (GMT date and time) of the last modification of the online status
     *
     * @return self
     */
